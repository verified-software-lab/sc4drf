...
static void init_array(int ni,int nj,int nk,int nl,int nm,double A[N + 0][N + 0],double B[N + 0][N + 0],double C[N + 0][N + 0],double D[N + 0][N + 0])
{
  //int i;
  //int j;
{
...
#pragma omp parallel for private(c2)
      for (c1 = 0; c1 <= ((((((ni + -1 < nj + -1?ni + -1 : nj + -1)) < nk + -1?((ni + -1 < nj + -1?ni + -1 : nj + -1)) : nk + -1)) < 
      nm + -1?((((ni + -1 < nj + -1?ni + -1 : nj + -1)) < nk + -1?((ni + -1 < nj + -1?ni + -1 : nj + -1)) : nk + -1)) : nm + -1)); c1++) {
        for (c2 = 0; c2 <= ((((((nj + -1 < nk + -1?nj + -1 : nk + -1)) < nl + -1?((nj + -1 < nk + -1?nj + -1 : nk + -1)) : nl + -1)) < 
        nm + -1?((((nj + -1 < nk + -1?nj + -1 : nk + -1)) < nl + -1?((nj + -1 < nk + -1?nj + -1 : nk + -1)) : nl + -1)) : nm + -1)); c2++) {
...
static void print_array(int ni,int nl,double G[N + 0][N + 0])
{
  int i;
  int j;
  for (i = 0; i < ni; i++) 
...
static void kernel_3mm(int ni,int nj,int nk,int nl,int nm,double E[N + 0][N + 0],double A[N + 0][N + 0],double B[N + 0][N + 0],double F[N + 0][N + 0],double C[N + 0][N + 0],double D[N + 0][N + 0],double G[N + 0][N + 0])
{
  //int i;
  //int j;
  //int k;
